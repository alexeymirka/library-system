...
public class AddNewReviewController {
    ...
    void initialize() {
        ...
        addNewReviewButton.setOnAction(event -> {
            confirmAllInf();
            try {
                ChangeWindow.changeWindow.openWindow(addNewReviewButton, "/com/alexsis/client/resources/user_window.fxml", "ОТЗЫВ добавлена!", null, null);
            } catch (IOException e) {
                e.printStackTrace();
            }
        });
